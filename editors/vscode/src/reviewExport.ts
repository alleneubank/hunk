...
export interface ReviewExport {
  ...
  /**
   * Conventional auto-discovery path for this review target when the binary reports one.
   * Omitted by older Hunk binaries; agents use it to write notes without hard-coding ids.
   */
